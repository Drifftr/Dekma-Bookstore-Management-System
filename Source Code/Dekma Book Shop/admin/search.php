...
//   echo "<p>Desc: $desc</p>";
   ...
   if($qty>0){
 echo "<a style='text-decoration: none' href='dbtools.php?action=remove&id=$isbn'>Remove Book</a> <br> <a style='text-decoration: none' href='edit.php?id=$isbn'>Edit This Book</a> ";
 }
 else{
